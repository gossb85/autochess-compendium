    ...
    <div className='row'>
      <div className='col-4' align='center'>
        <div className='row'>
          <div className='col mb-4'>
            <h3>
              <font color='#fbf066'>Assassin</font>
            </h3>
            <span>
        ...
        <div className='row'>
          <div className='col mb-4'>
            <h3>
              <font color='#521865'>Demon Hunter </font>
            </h3>
            <span>
      ...
      <div className='col-4' align='center'>
        ...
        <div className='row'>
          <div className='col mb-4'>
            <h3>
              <font color='#9382c9'>Warlock </font>
            </h3>
            <span>
        ...
        <div className='row'>
          <div className='col mb-4'>
            <h3>
              <font color='#c59a6c'>Warrior </font>
            </h3>
            <span>

      ...
      <div className="col-md-8">
        <div>
          ...
          <div className="row card-formatting-bottom py-1 mb-3">
            <div className="col-3">
              <img
                className="image-responsive mx-auto my-1 d-block"
                width="80px"
                height="80px"
                src={activeHero.race1Icon}
                alt=""
              />
            </div>
            <div className="col-9">
        ...
        <div>
          <div className="row card-formatting-top">
            ...
            {activeHero.ability1DmgType && (
              <div className="col">{activeHero.ability1DmgType}</div>
            )}
            {activeHero.ability1Target && (
              <div className="col">{activeHero.ability1Target}</div>
            )}
            {activeHero.ability1Duration && (
              <div className="col">{activeHero.ability1Duration}</div>
            )}
          </div>
          <div className="row card-formatting-bottom py-1 mb-3">
            <div className="col-3">
              <img
                ...
                width="80px"
                height="80px"
                src={activeHero.ability1Icon}
                alt=""
              />
            </div>
            <div className="col-9">
              <p>{activeHero.ability1Description}</p>
              {activeHero.ability1Damage && (
                <span className="float-left">{activeHero.ability1Damage}</span>
              )}
              {activeHero.ability1Cooldown && (
        ...
        {activeHero.ability2Name && (
          <div>
            <div className="row card-formatting-top">
              ...
              {activeHero.ability2DmgType && (
                <div className="col">{activeHero.ability2DmgType}</div>
              )}
              {activeHero.ability2Target && (
                <div className="col">{activeHero.ability2Target}</div>
              )}
              {activeHero.ability2Duration && (
                <div className="col">{activeHero.ability2Duration}</div>
              )}
            </div>
            <div className="row card-formatting-bottom py-1 mb-3">
              <div className="col-3">
                <img
                  ...
                  width="80px"
                  height="80px"
                  src={activeHero.ability2Icon}
                  alt=""
                />
              </div>
              <div className="col-9">
                <p>{activeHero.ability2Description}</p>
                {activeHero.ability2Damage && (
                  <span className="float-left">
                    {activeHero.ability2Damage}
                  </span>
                )}
                {activeHero.ability2Cooldown && (
                  <span className="float-right">
                    {activeHero.ability2Cooldown}
                  </span>
                )}
